      ...
      <Grid container spacing={2}>
        <Grid item xs={12}>
          <Box display="flex" flexDirection={{ xs: 'column', md: 'row' }} alignItems="flex-start" justifyContent="center" p={{ md: 2, sm: 0 }} m={2} bgcolor="#5A189A" boxShadow={3} borderRadius={2}>
            ...
            <Box flex="1" p={2} height={{ xs: 'auto', md: '550px' }} bgcolor="#5A189A" color="white" borderRadius={2} boxShadow={3} overflow="auto" alignItems="center" justifyContent="center" width={{xs:'90%'}} textAlign='center'>
        ...
        <Grid item xs={12}>
          <Box display="flex" justifyContent="space-evenly" m={4} flexDirection={{ xs: 'column', sm: 'row' }}>
            ...
            <Button variant="contained" href="/auth/students/games/addition" startIcon={<SportsEsports />} sx={{ backgroundColor:'#7B2CBF', mb: { xs: 2, sm: 0 } }}>Juego de sumas</Button>
            <Button variant="contained" href="/auth/students/quizes/addition" startIcon={<School />} sx={{backgroundColor:'#7B2CBF'}}>Examen</Button>
          </Box>
        </Grid>
      </Grid>
    </main>
